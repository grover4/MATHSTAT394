...
c. The probability $P(X \geq 7)$ quantifies how unusually large an observed value of 7 is under the presumed distribution. Calculate this number in a code chunk manually as well as by using an R function. Be sure to show the numbers.
